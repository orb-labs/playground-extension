...
import { AddEthereumChainProposedChain } from '@rainbow-me/provider/dist/references/chains';
import { errorCodes } from '@rainbow-me/provider/dist/references/errorCodes';
import {
  CallbackOptions,
...
import {
  ...
  getDappHost,
  isValidUrl,
} from '@rainbow-me/provider/dist/utils/apps';
import { normalizeTransactionResponsePayload } from '@rainbow-me/provider/dist/utils/ethereum';
...
export const rnbwHandleProviderRequest = ({
  ...
  getChainNativeCurrency: (chainId: number) => any | undefined;
  ...
  providerRequestTransport?.reply(async ({ method, id, params }, meta) => {
    try {
      ...
      switch (method) {
        ...
        case 'eth_coinbase': {
          response = validateAndFormatAddress(activeSession?.address) || '';
          break;
        }
        case 'eth_accounts': {
        ...
        case 'eth_requestAccounts': {
          ...
          response = [validateAndFormatAddress(address)];
          break;
        }
